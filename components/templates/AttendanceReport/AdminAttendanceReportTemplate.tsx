...
export default function AdminAttendanceReportTemplate(props: { listData: any }) {
    ...
    const UserAttendance = ({ item }: { item: any }) => {
        ...
        return (
            ...
            <View style={{ padding: 2, borderColor: '#D2D7D7', borderBottomWidth: 1, paddingBottom: 5 }}>
                ...
                <MyText text={item.LeaveTypeName ?? item.LeaveType} color='#000' bold style={{ textAlign: 'right' }} />
            </View>
            //     )
            // })
        )
